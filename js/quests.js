    ...
    if (id === 'lionheart'){
      if (!f.map){
        ...
        DLG.say([
          ...
          CAT('lionheart', 'Peace, Scarlett of the Twolegplace. You are safe. You have slept your way between worlds — this is Fourtrees, heart of the forest of the warrior clans.'),
          ...
          CAT('lionheart', 'I need them back, Scarlett. Every one. Only when all fifteen shine at Fourtrees again will the way home open — place them in my paws, and you will wake on Bus 15 as if you never left it.'),
          CAT('lionheart', 'Fifteen collars, carried by a friend on her fifteenth birthday. The stars do enjoy their symmetries... happy birthday, dear one.'),
